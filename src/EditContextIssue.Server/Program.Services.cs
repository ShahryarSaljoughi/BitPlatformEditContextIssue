...
using EditContextIssue.Server.Services;
using EditContextIssue.Client.Web;
using Microsoft.AspNetCore.HttpOverrides;
using Microsoft.AspNetCore.ResponseCompression;
using System.Net.Mail;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using EditContextIssue.Server.Models.Identity;
...
namespace EditContextIssue.Server;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "EditContextIssue.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "EditContextIssue.Shared.xml"));
