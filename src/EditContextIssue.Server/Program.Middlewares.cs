...
using System.Web;
using EditContextIssue.Client.Core.Services;
...
public static partial class Program
{
    ...
    public static void ConfiureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<EditContextIssue.Server.Components.App>()
            .AddInteractiveServerRenderMode()
            .AddInteractiveWebAssemblyRenderMode()
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("EditContextIssue") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
