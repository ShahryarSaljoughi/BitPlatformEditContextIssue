using System.Web;
using EditContextIssue.Client.Core.Controllers.Identity;
using EditContextIssue.Server.Components;
using EditContextIssue.Server.Models.Emailing;
using EditContextIssue.Server.Models.Identity;
using EditContextIssue.Server.Resources;
...
namespace EditContextIssue.Server.Controllers.Identity;
